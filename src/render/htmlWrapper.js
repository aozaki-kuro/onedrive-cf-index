...
const COMMIT_HASH = 'd1d5fb69df6e2a7d3f32e5ce0e6d7aaf30e7697e'
...
export function renderHTML(body, pLink, pIdx) {
  ...
  <html lang="en">
    ...
    <body>
      ...
      <footer id="footer" data-turbolinks-permanent><img src="https://img.shields.io/badge/Hosted%20on-CF%20Workers-f38020?logo=cloudflare&logoColor=f38020&labelColor=282d33" alt="hosted on cloudflare workers"> <img src="https://img.shields.io/badge/Stored%20in-OneDrive%20for%20Business-blue?logo=microsoft%20onedrive&logoColor=0078d4&labelColor=282d33" alt="Stored in OneDrive for Business"></footer>
      <script>
